...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		var bgg = new FlxBackdrop().loadGraphic("assets/images/checkb1.png");
		add(bgg);
		bgg.velocity.set(100, 100);
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			{
				case 1:
					createCoolText(['A Self Insert Mod'], 45);
				// credTextShit.visible = true;
				case 3:
					addMoreText('by Sulayre', 45);
					addMoreText('made with Psych Engine', 45);
				// credTextShit.text += '\npresent...';
				...
				// credTextShit.visible = true;
				case 14:
					addMoreText('Creative');
				// credTextShit.text += '\nNight';
				case 15:
					addMoreText('Burnout'); // credTextShit.text += '\nFunkin';
